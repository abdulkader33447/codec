...
const Portfolio = () => {
  ...
  const portfolioImages = [
    ...
    { src: imagSix, alt: "laptop-table mouse note book imag", category: "Card" },
  ];
  ...
  return (
    <div className="bg-[#333333] py-12">
      <div className="max-w-[1320px] w-11/12 mx-auto text-[#cccccc]">
        <h1 className="text-2xl text-center font-semibold">Our Portfolio</h1>
        ...
        >
          {displayedImages.map((item, index) => (
            ...
            >
              ...
              {/* icons on hover (no hover effect on icons) */}
