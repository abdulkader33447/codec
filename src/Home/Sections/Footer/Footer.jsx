const Footer = () => {
  return (
    <div className="bg-[#2d2d2d] text-gray-300 py-16">
      <div className="max-w-[1320px] w-11/12 mx-auto px-6 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
        {/* Brand Section */}
        <div>
        ...
        <div>
          ...
          <ul className="space-y-2 mt-6">
            ...
            <li><a href="#" className="hover:text-white transition-colors">Woocommerce</a></li>
            <li><a href="#" className="hover:text-white transition-colors">Brand Image</a></li>
          </ul>
        </div>
        ...
        <div>
          ...
          <div className="space-y-2 mt-6">
            ...
            <div className="flex gap-3 pt-4">
              ...
              <a
                href="#"
                className="w-9 h-9 bg-[#3a3a3a] flex items-center justify-center rounded hover:bg-[#6cb42c] transition-colors"
              >
      ...
      <div className="border-t border-gray-700 mt-12 pt-6 text-center text-sm">
        <p>
          © Copyright <span className="font-semibold">Deshit-BD</span> | All Rights Reserved
        </p>
      </div>
    </div>
  );
